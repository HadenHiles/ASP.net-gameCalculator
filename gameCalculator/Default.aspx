...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluent">
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="alert_wrapper">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" 
                                                    ...
                                                    Display="Dynamic"
                                                    cssClass="alert alert-danger"
                                                    ErrorMessage="You must enter the number of goals allowed!"
                                                    runat="server">
                        </asp:RequiredFieldValidator>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="alert_wrapper">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" 
                                                    ...
                                                    Display="Dynamic"
                                                    cssClass="alert alert-danger"
                                                    ErrorMessage="You must enter the number of spectators!"
                                                    runat="server">
                        </asp:RequiredFieldValidator>
                    </div>
                    <div class="clear"></div>
            ...
            <asp:Button ID="btnCalculate" CssClass="btn btn-primary center" runat="server" Text="Summary" OnClick="btnCalculate_Click" />
        </div>
    </div>
</asp:Content>
